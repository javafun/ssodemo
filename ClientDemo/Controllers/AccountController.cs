...
namespace ClientDemo.Controllers
{
    ...
    {
        private const string ClientUri = @"https://localhost:44347";
        private const string CallbackEndpoint = ClientUri + @"/account/signInCallback";
        private const string IdServBaseUri = @"https://localhost:44346/core";
        ...
        {
            var a = this.Request.GetOwinContext().Authentication.User.Claims;
